...
# ตั้งค่าฟอนต์ภาษาไทย (สำหรับ Windows มักจะใช้ Tahoma หรือ Cordia New, Mac ใช้ Thonburi)
...
# ==========================================
# กราฟที่ 1: ความนิยมโดยรวม (ติด Top 3)
# ==========================================
...
# ==========================================
# กราฟที่ 2: ความสัมพันธ์กับเป้าหมายการซื้อ (Correlation)
# ==========================================
...
# ==========================================
# กราฟที่ 3: เปรียบเทียบมิติคะแนน (Radar Chart)
# ==========================================
# ดึงเฉพาะตัวท็อปมาแข่งกัน: Option 2, Option 3, Option 6
...
# กำหนดสีให้ตัวท็อป (ให้ Option 6 เด่นสุด และ 3 กับ 2 เป็นสีรอง)
...
ax.set_ylim(2.8, 4.2) # ปรับสเกลให้เห็นความต่างของตัวท็อปชัดๆ
...
# กราฟที่ 4
# ดึงคอลัมน์ "ความรู้สึกอยากซื้อ" ของ Option 3 และ Option 6
...
# คำนวณคะแนนเฉลี่ยโดยแยกตาม "คนที่ซื้อจริง" (Target=1) และ "คนที่ไม่ซื้อ" (Target=0)
...
plt.axhline(y=4.0, color='gray', linestyle='--', alpha=0.5) # เส้นแบ่งเกณฑ์คะแนนสูง
plt.tight_layout()
plt.show()